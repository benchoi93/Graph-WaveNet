...
from Fixed_mdn_engine_kronecker import MDN_trainer
...
model_path = "logs/GWNMDN_kronecker_20220825-094251_N8_R12_reg0.0_nhid16_pred[2, 5, 8, 11]_rho0.01_diagFalse_msecoef1.0"
...
def main(model_path, dataloader, adj_mx, target_sensors, target_sensor_inds, num_nodes):
    ...
    engine.load(model_path=model_path + '/best_model.pt',
                ...
                fc_ws_path=model_path + '/best_fc_ws.pt',
                fc_wt_path=model_path + '/best_fc_wt.pt')
...
if __name__ == "__main__":
    ...
    logpath = "logs0904kronecker"
    savepath = "out_kronecker_0904.csv"

    file_list = [x for x in os.listdir(logpath) if "kronecker" in x]
    ...
    for file in tqdm(file_list):
        print(file)
        # try:
        result_rmse, result_mape, result_mae, result_crps, result_ES = main(
